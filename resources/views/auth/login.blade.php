...
<div class="relative min-h-screen flex ">
    <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
      <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative"
        style="background-image: url(https://www.eltelegrafo.com.ec/media/k2/items/cache/d008a601d3cdc193050395916d7cc462_XL.jpg);">
        <div class="absolute bg-gradient-to-b from-green-600 to-lime-500 opacity-75 inset-0 z-0"></div>
        <div class="w-full  max-w-md z-10">
          <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">No vamos a cambiar el mundo ayudando a un animal, pero al menos el mundo habrá cambiado para él...</div>
          <div class="sm:text-sm xl:text-md text-gray-200 font-normal"> Según la organización Animales SOS Bolivia se afirma que en la ciudad de La Paz hay 250.000 perros callejeros, mientras que en El Alto hay 300.000.
        </div>
        </div>
        <!---remove custom style-->
       <ul class="circles">
      ...
      <div class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
        <div class="max-w-md w-full space-y-8">
          ...
          <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
            ...
            <div>
              <button type="submit"
                class="w-full flex justify-center bg-gradient-to-r from-green-500 to-blue-600  hover:bg-gradient-to-l hover:from-green-500 hover:to-indigo-600 text-gray-100 p-4  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                Inicia sesión
              </button>
            </div>
